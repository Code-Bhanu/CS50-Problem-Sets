...
def buy():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            ...
            return apology("please provide valid price", 400)
        ...
        if user_cash < (shares_price):
            return apology("Funds insufficient", 400)
        else:
            db.execute(
            ...
            flash("Transaction is successful")
            return redirect("/")
...
def register():
    if request.method == "POST":
        ...
        # Ensure passwords match
            ...
            return apology("Both the passwords must match", 400)
